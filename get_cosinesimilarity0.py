...
model_novice = KeyedVectors.load_word2vec_format("very_novice_epoch0.bin", binary=True) 
model_expert = KeyedVectors.load_word2vec_format("expert_epoch0.bin", binary=True)
