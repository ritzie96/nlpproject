...
class EpochSaver(CallbackAny2Vec):
    ...
    def on_epoch_end(self, model):
        ...
        model.wv.save_word2vec_format('very_novice_epoch{}.bin'.format(self.epoch), binary=True)
        self.epoch += 1
            ...
            for fi in filenames:
                for line in open(os.path.join(dirpath,fi), mode="r",encoding="utf-8"):
                    ...
                    if a not in neg_titles:
                        ...
                        with open('latestused_exception_list.txt','a') as f:
                            f.write('"'+str(a)+'"'+',\n')
...
if __name__ == '__main__':
    ...
    sentences = MySentences('/home/rithikachordia7/rithika/extracted')       
