...
def json_readr(path):
    neg_titles=["Dance", "History_of_dance", "List_of_dance_style_categories", "List_of_national_dances", "List_of_ethnic,_regional,_and_folk_dances_by_origin", "List_of_dance_occupations","Choreography","Outline_of_dance","Dance_move","Dance_technology","List_of_dance_companies","List_of_dancers","Group_dance","Dance_and_health","Dancing_mania"
               ,"Modern_dance","Dance_education","Dance_in_mythology_and_religion","Dance_therapy","Dance_music", "First-person_shooter", "Category:First-person_shooters", "Doom_(1993_video_game)", "Counter-Strike_(video_game)", "Wolfenstein_3D", "Call_of_Duty", "Quake_(video_game)", "Battlefield_(video_game_series)", "First-person_shooter_engine", "Multiplayer_video_game", "Shooter_game", "Esports", "Arrow_keys#WASD_keys", "Level_(video_gaming)", "Hitscan",
"Badminton", "Badminton_World_federation", "Shuttlecock", "Racket_(sports_equipment)#Badminton", "Net_(device)", "BWF_World_Ranking", "Presidencies_and_provinces_of_British_India", "Badminton_House", "Badminton_England",
 "Badminton_Europe", "Badminton_Asia", "Badminton_Pan_Am", "Badminton_Confederation_of_Africa", "Badminton_Oceania", "BWF_World_Championships", "BWF_World_Tour", "All_England_Open_Badminton_Championships",
 "BWF_Super_Series", "Scoring_system_development_of_badminton", "Ball_badminton", "Speed_badminton", "Hanetsuki",
